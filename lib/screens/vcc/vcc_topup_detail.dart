...
// class VccTopupDetail extends StatefulWidget {
//   Map<String, dynamic> data;
//   VccTopupDetail({required this.data, Key? key}) : super(key: key);

//   @override
//   State<VccTopupDetail> createState() => _VccTopupDetailState();
// }

// class _VccTopupDetailState extends State<VccTopupDetail> {
//   double? subtotal;
//   double? total;
//   double? feeFinal;
...
//     return Scaffold(
//       appBar: CommonWidgets().buildCommonAppBar("Top up VCC"),
//       body: Column(
//         mainAxisAlignment: MainAxisAlignment.start,
//         children: [
//           buildTopSection(),
